...
* **Parameter Sharing:** Depthwise convolution takes parameter sharing to the extreme—each filter is shared spatially but restricted to a single channel, minimizing weights.
