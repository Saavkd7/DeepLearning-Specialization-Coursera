...
* **Initialization:** In Course 2, we learned that good initialization is crucial. Transfer learning provides the *ultimate* initialization—weights that already know how to "see" the world.
