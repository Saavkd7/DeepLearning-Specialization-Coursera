...
Today  **Monday, 05 Jan 2026**.

## General Counter
It has been    **141** days since I started this diary.

# Repository Counter

Day **13** From I started this repository
...
$$W^{[l]} = W^{[l]} - \alpha \cdot \left( dW^{[l]}_{\text{backprop}} + \frac{\lambda}{m} W^{[l]} \right)$$

This can be rewritten as:

$$W^{[l]} = \underbrace{\left( 1 - \frac{\alpha \lambda}{m} \right)}_{\text{Decay Factor}} W^{[l]} - \alpha \cdot dW^{[l]}_{\text{backprop}}$$
